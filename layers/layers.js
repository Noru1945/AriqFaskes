...
var format_Admin_Kecamatan_TNG_3 = new ol.format.GeoJSON();
var features_Admin_Kecamatan_TNG_3 = format_Admin_Kecamatan_TNG_3.readFeatures(json_Admin_Kecamatan_TNG_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Admin_Kecamatan_TNG_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Admin_Kecamatan_TNG_3.addFeatures(features_Admin_Kecamatan_TNG_3);
var lyr_Admin_Kecamatan_TNG_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Admin_Kecamatan_TNG_3, 
                style: style_Admin_Kecamatan_TNG_3,
                popuplayertitle: 'Admin_Kecamatan_TNG',
                interactive: true,
                title: '<img src="styles/legend/Admin_Kecamatan_TNG_3.png" /> Admin_Kecamatan_TNG'
            });
var format_Jalan_TNG_4 = new ol.format.GeoJSON();
var features_Jalan_TNG_4 = format_Jalan_TNG_4.readFeatures(json_Jalan_TNG_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Jalan_TNG_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Jalan_TNG_4.addFeatures(features_Jalan_TNG_4);
var lyr_Jalan_TNG_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Jalan_TNG_4, 
                style: style_Jalan_TNG_4,
                popuplayertitle: 'Jalan_TNG',
                interactive: true,
    title: 'Jalan_TNG<br />\
    <img src="styles/legend/Jalan_TNG_4_0.png" /> Jalan Arteri<br />\
    <img src="styles/legend/Jalan_TNG_4_1.png" /> Jalan Kolektor<br />\
    <img src="styles/legend/Jalan_TNG_4_2.png" /> Jalan Tol Dua Jalur Dengan Pemisah Fisik<br />' });
...
var format_Rumah_Sakit_TNG_6 = new ol.format.GeoJSON();
var features_Rumah_Sakit_TNG_6 = format_Rumah_Sakit_TNG_6.readFeatures(json_Rumah_Sakit_TNG_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Rumah_Sakit_TNG_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Rumah_Sakit_TNG_6.addFeatures(features_Rumah_Sakit_TNG_6);
var lyr_Rumah_Sakit_TNG_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Rumah_Sakit_TNG_6, 
                style: style_Rumah_Sakit_TNG_6,
                popuplayertitle: 'Rumah_Sakit_TNG',
                interactive: true,
                title: '<img src="styles/legend/Rumah_Sakit_TNG_6.png" /> Rumah_Sakit_TNG'
            });

lyr_GoogleMaps_0.setVisible(true);lyr_EsriImagery_1.setVisible(true);lyr_Admin_Kelurahan_TNG_2.setVisible(true);lyr_Admin_Kecamatan_TNG_3.setVisible(true);lyr_Jalan_TNG_4.setVisible(true);lyr_Puskesmas_TNG_5.setVisible(true);lyr_Rumah_Sakit_TNG_6.setVisible(true);
var layersList = [lyr_GoogleMaps_0,lyr_EsriImagery_1,lyr_Admin_Kelurahan_TNG_2,lyr_Admin_Kecamatan_TNG_3,lyr_Jalan_TNG_4,lyr_Puskesmas_TNG_5,lyr_Rumah_Sakit_TNG_6];
...
lyr_Admin_Kecamatan_TNG_3.set('fieldAliases', {'WADMKC': 'WADMKC', });
lyr_Jalan_TNG_4.set('fieldAliases', {'REMARK': 'REMARK', });
...
lyr_Rumah_Sakit_TNG_6.set('fieldAliases', {'namobj': 'namobj', 'rsalamat': 'rsalamat', 'jplyrs': 'jplyrs', 'FCODE': 'FCODE', 'REMARK': 'REMARK', 'METADATA': 'METADATA', 'SRS_ID': 'SRS_ID', 'TIPRST': 'TIPRST', });
...
lyr_Admin_Kecamatan_TNG_3.set('fieldImages', {'WADMKC': 'TextEdit', });
lyr_Jalan_TNG_4.set('fieldImages', {'REMARK': 'TextEdit', });
lyr_Puskesmas_TNG_5.set('fieldImages', {'NAMOBJ': 'TextEdit', 'FCODE': 'TextEdit', 'REMARK': 'TextEdit', 'SRS_ID': 'TextEdit', 'METADATA': 'TextEdit', 'JPLPKM': 'TextEdit', 'KMPPKM': 'TextEdit', 'PKMKAT': 'TextEdit', 'PKMKODE': 'TextEdit', 'PKMLMT': 'TextEdit', 'KWKPKM': 'TextEdit', });
lyr_Rumah_Sakit_TNG_6.set('fieldImages', {'namobj': 'TextEdit', 'rsalamat': 'TextEdit', 'jplyrs': 'TextEdit', 'FCODE': 'TextEdit', 'REMARK': 'TextEdit', 'METADATA': 'TextEdit', 'SRS_ID': 'TextEdit', 'TIPRST': 'TextEdit', });
...
lyr_Admin_Kecamatan_TNG_3.set('fieldLabels', {'WADMKC': 'inline label - always visible', });
lyr_Jalan_TNG_4.set('fieldLabels', {'REMARK': 'inline label - always visible', });
...
lyr_Rumah_Sakit_TNG_6.set('fieldLabels', {'namobj': 'inline label - always visible', 'rsalamat': 'inline label - always visible', 'jplyrs': 'no label', 'FCODE': 'no label', 'REMARK': 'no label', 'METADATA': 'no label', 'SRS_ID': 'no label', 'TIPRST': 'no label', });
lyr_Rumah_Sakit_TNG_6.on('precompose', function(evt) {
